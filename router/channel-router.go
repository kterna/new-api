...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/temp-disable-status", permission: authz.ChannelRead, handler: controller.GetTemporaryDisableStatus},
	...
	{method: http.MethodGet, path: "/:id/usage", permission: authz.ChannelRead, handler: controller.GetChannelUsage},
	{method: http.MethodPost, path: "/:id/clear-temp-disable", permission: authz.ChannelOperate, handler: controller.ClearTemporaryDisableStatus},
